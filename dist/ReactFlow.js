  ...
  if (options.initial && !fitViewOnInitDone && fitViewOnInit || !options.initial) {
    if (d3Zoom$1 && d3Selection) {
      ...
      if (nodes.length > 0 && nodesInitialized) {
        ...
        var nextTransform = d3Zoom.zoomIdentity.translate(x, y).scale(zoom);

        if (typeof options.duration === 'number' && options.duration > 0) {
          d3Zoom$1.transform(getD3Transition(d3Selection, options.duration), nextTransform);
        } else {
          d3Zoom$1.transform(d3Selection, nextTransform);
        }
...
var _createContext = createContext__default["default"](),
...
var useKeyPress = (function () {
  ...
  var pressedKeys = React.useRef(new Set([])); // keyCodes = array with single keys [['a']] or key combinations [['a', 's']]
...
var useGlobalKeyHandler = (function (_ref) {
  ...
  var _useStore = useStore(selector$g, shallow__default["default"]),
...
var ZoomPane = function ZoomPane(_ref) {
  ...
  var _useStore = useStore(selector$f, shallow__default["default"]),
      d3Zoom$1 = _useStore.d3Zoom,
      d3Selection$1 = _useStore.d3Selection,
  ...
  React.useEffect(function () {
    if (zoomPane.current) {
      ...
      var d3ZoomInstance = d3Zoom.zoom().scaleExtent([minZoom, maxZoom]).translateExtent(translateExtent);
      var selection = d3Selection.select(zoomPane.current).call(d3ZoomInstance);
      ...
      var updatedTransform = d3Zoom.zoomIdentity.translate(clampedX, clampedY).scale(clampedZoom);
  ...
  React.useEffect(function () {
    if (d3Selection$1 && d3Zoom$1) {
      if (panOnScroll && !zoomActivationKeyPressed) {
        d3Selection$1.on('wheel', function (event) {
          ...
          var currentZoom = d3Selection$1.property('__zoom').k || 1;

          if (event.ctrlKey && zoomOnPinch) {
            var point = d3Selection.pointer(event); // taken from https://github.com/d3/d3-zoom/blob/master/src/zoom.js

            var pinchDelta = -event.deltaY * (event.deltaMode === 1 ? 0.05 : event.deltaMode ? 1 : 0.002) * 10;

            var _zoom = currentZoom * Math.pow(2, pinchDelta);

            d3Zoom$1.scaleTo(d3Selection$1, _zoom, point);
            return;
          ...
          d3Zoom$1.translateBy(d3Selection$1, -(deltaX / currentZoom) * panOnScrollSpeed, -(deltaY / currentZoom) * panOnScrollSpeed);
        }).on('wheel.zoom', null);
  ...
  }, [panOnScroll, panOnScrollMode, d3Selection$1, d3Zoom$1, d3ZoomHandler, zoomActivationKeyPressed, zoomOnPinch, preventScrolling, noWheelClassName]);
  React.useEffect(function () {
    if (d3Zoom$1) {
      if (selectionKeyPressed) {
        d3Zoom$1.on('zoom', null);
      } else {
        d3Zoom$1.on('zoom', function (event) {
          store.setState({
  ...
  }, [selectionKeyPressed, d3Zoom$1, onMove]);
  React.useEffect(function () {
    if (d3Zoom$1) {
      if (onMoveStart) {
        d3Zoom$1.on('start', function (event) {
          var flowTransform = eventToFlowTransform(event.transform);
          prevTransform.current = flowTransform;
          onMoveStart(event.sourceEvent, flowTransform);
        });
      } else {
        d3Zoom$1.on('start', null);
      }
    }
  }, [d3Zoom$1, onMoveStart]);
  React.useEffect(function () {
    if (d3Zoom$1) {
      if (onMoveEnd) {
        d3Zoom$1.on('end', function (event) {
        ...
        d3Zoom$1.on('end', null);
      }
    }
  }, [d3Zoom$1, onMoveEnd]);
  React.useEffect(function () {
    if (d3Zoom$1) {
      d3Zoom$1.filter(function (event) {
  ...
  }, [d3Zoom$1, zoomOnScroll, zoomOnPinch, panOnScroll, zoomOnDoubleClick, panOnDrag, selectionKeyPressed, elementsSelectable, zoomActivationKeyPressed]);
...
var UserSelection = /*#__PURE__*/React.memo(function (_ref) {
  ...
  var store = useStoreApi();
  var prevSelectedNodesCount = React.useRef(0);
  var prevSelectedEdgesCount = React.useRef(0);
  var containerBounds = React.useRef();
  ...
  var _useStore = useStore(selector$e, shallow__default["default"]),
  ...
  var resetUserSelection = React.useCallback(function () {
  ...
  }, userSelectionRect.draw && /*#__PURE__*/React__default["default"].createElement("div", {
...
function NodesSelection(_ref5) {
  ...
  var _useStore = useStore(selector$d, shallow__default["default"]),
  ...
  var selectedNodesBbox = React.useMemo(function () {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: cc__default["default"](['react-flow__nodesselection', 'react-flow__container', noPanClassName]),
    style: style
  }, /*#__PURE__*/React__default["default"].createElement(reactDraggable.DraggableCore, {
    scale: tScale,
    grid: grid,
...
var NodesSelection$1 = /*#__PURE__*/React.memo(NodesSelection);
...
var FlowRenderer = function FlowRenderer(_ref) {
  ...
  var _useStore = useStore(selector$c, shallow__default["default"]),
      resetSelectedElements = _useStore.resetSelectedElements,
  ...
  return /*#__PURE__*/React__default["default"].createElement(ZoomPane, {
    ...
    selectionKeyPressed: selectionKeyPressed
  }), nodesSelectionActive && /*#__PURE__*/React__default["default"].createElement(NodesSelection$1, {
...
function useVisibleNodes(onlyRenderVisible) {
  var nodes = useStore(React.useCallback(function (s) {
...
var NodeRenderer = function NodeRenderer(props) {
  var _useStore = useStore(selector$b, shallow__default["default"]),
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    return /*#__PURE__*/React__default["default"].createElement(NodeComponent, {
      ...
      type: nodeType,
      data: node.data,
      sourcePosition: node.sourcePosition || exports.Position.Bottom,
      targetPosition: node.targetPosition || exports.Position.Top,
      hidden: node.hidden,
...
var EdgeText = function EdgeText(_ref) {
  ...
  var edgeTextClasses = cc__default["default"](['react-flow__edge-textwrapper', className]);
  React.useEffect(function () {
    if (edgeRef.current) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("g", _objectSpread$c({
...
var ConnectionLine = (function (_ref) {
  ...
  var _useStore = useStore(selector$a, shallow__default["default"]),
      nodeInternals = _useStore.nodeInternals,
      transform = _useStore.transform;

  var sourceNode = React.useRef(nodeInternals.get(nodeId));
...
var MarkerSymbols = (_MarkerSymbols = {}, _defineProperty(_MarkerSymbols, exports.MarkerType.Arrow, ArrowSymbol), _defineProperty(_MarkerSymbols, exports.MarkerType.ArrowClosed, ArrowClosedSymbol), _MarkerSymbols);
...
var MarkerDefinitions = function MarkerDefinitions(_ref2) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("defs", null, markers.map(function (marker) {
    return /*#__PURE__*/React__default["default"].createElement(Marker, {
      id: marker.id,
      key: marker.id,
      type: marker.type,
...
var EdgeAnchor = function EdgeAnchor(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("circle", {
    className: cc__default["default"](['react-flow__edgeupdater', className]),
...
var wrapEdge = (function (EdgeComponent) {
  var EdgeWrapper = function EdgeWrapper(_ref) {
    ...
    var _useStore = useStore(selector$9, shallow__default["default"]),
    ...
    var edgeClasses = cc__default["default"](['react-flow__edge', "react-flow__edge-".concat(type), className, {
      selected: selected,
      animated: animated,
      inactive: inactive,
      updating: updating
    ...
    var markerStartUrl = React.useMemo(function () {
      return "url(#".concat(getMarkerId(markerStart), ")");
    }, [markerStart]);
    var markerEndUrl = React.useMemo(function () {
...
function useVisibleEdges(onlyRenderVisible, nodeInternals) {
  var edges = useStore(React.useCallback(function (s) {
...
var EdgeRenderer = function EdgeRenderer(props) {
  var _useStore = useStore(selector$8, shallow__default["default"]),
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, edgeTree.map(function (_ref) {
    ...
    return /*#__PURE__*/React__default["default"].createElement("svg", {
    ...
    }, isMaxLevel && /*#__PURE__*/React__default["default"].createElement(MarkerDefinitions, {
      defaultColor: defaultMarkerColor
    }), /*#__PURE__*/React__default["default"].createElement("g", null, edges.map(function (edge) {
      ...
      var targetNodeHandles = connectionMode === exports.ConnectionMode.Strict ? targetHandleBounds.target : targetHandleBounds.target || targetHandleBounds.source;
      ...
      var sourcePosition = (sourceHandle === null || sourceHandle === void 0 ? void 0 : sourceHandle.position) || exports.Position.Bottom;
      var targetPosition = (targetHandle === null || targetHandle === void 0 ? void 0 : targetHandle.position) || exports.Position.Top;
      ...
      return /*#__PURE__*/React__default["default"].createElement(EdgeComponent, {
        key: edge.id,
        id: edge.id,
        className: cc__default["default"]([edge.className, props.noPanClassName]),
        type: edgeType,
        data: edge.data,
    ...
    }), renderConnectionLine && isMaxLevel && /*#__PURE__*/React__default["default"].createElement(ConnectionLine, {
...
var useViewportHelper = function useViewportHelper() {
  ...
  var _useStore = useStore(selector$6, shallow__default["default"]),
      d3Zoom$1 = _useStore.d3Zoom,
      d3Selection = _useStore.d3Selection;

  var viewportHelperFunctions = React.useMemo(function () {
    if (d3Selection && d3Zoom$1) {
      return {
        zoomIn: function zoomIn(options) {
          return d3Zoom$1.scaleBy(getD3Transition(d3Selection, options === null || options === void 0 ? void 0 : options.duration), 1.2);
        },
        zoomOut: function zoomOut(options) {
          return d3Zoom$1.scaleBy(getD3Transition(d3Selection, options === null || options === void 0 ? void 0 : options.duration), 1 / 1.2);
        },
        zoomTo: function zoomTo(zoomLevel, options) {
          return d3Zoom$1.scaleTo(getD3Transition(d3Selection, options === null || options === void 0 ? void 0 : options.duration), zoomLevel);
        },
        getZoom: function getZoom() {
        ...
        setViewport: function setViewport(transform, options) {
          var nextTransform = d3Zoom.zoomIdentity.translate(transform.x, transform.y).scale(transform.zoom);
          d3Zoom$1.transform(getD3Transition(d3Selection, options === null || options === void 0 ? void 0 : options.duration), nextTransform);
        },
        getViewport: function getViewport() {
        ...
        setCenter: function setCenter(x, y, options) {
          ...
          var transform = d3Zoom.zoomIdentity.translate(centerX, centerY).scale(nextZoom);
          d3Zoom$1.transform(getD3Transition(d3Selection, options === null || options === void 0 ? void 0 : options.duration), transform);
        },
        fitBounds: function fitBounds(bounds, options) {
          ...
          var transform = d3Zoom.zoomIdentity.translate(x, y).scale(zoom);
          d3Zoom$1.transform(getD3Transition(d3Selection, options === null || options === void 0 ? void 0 : options.duration), transform);
        },
        project: function project(position) {
...
function useReactFlow() {
  ...
  var store = useStoreApi();
  var getNodes = React.useCallback(function () {
    var _store$getState = store.getState(),
        nodeInternals = _store$getState.nodeInternals;
  ...
  var getNode = React.useCallback(function (id) {
    var _store$getState2 = store.getState(),
        nodeInternals = _store$getState2.nodeInternals;

    return nodeInternals.get(id);
  }, []);
  var getEdges = React.useCallback(function () {
    var _store$getState3 = store.getState(),
  ...
  var getEdge = React.useCallback(function (id) {
  ...
  var setNodes = React.useCallback(function (payload) {
  ...
  var setEdges = React.useCallback(function (payload) {
  ...
  var addNodes = React.useCallback(function (payload) {
  ...
  var addEdges = React.useCallback(function (payload) {
  ...
  var toObject = React.useCallback(function () {
...
var GraphView = function GraphView(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(FlowRenderer$1, {
    ...
    noWheelClassName: noWheelClassName,
    noPanClassName: noPanClassName
  }, /*#__PURE__*/React__default["default"].createElement(Viewport, null, /*#__PURE__*/React__default["default"].createElement(EdgeRenderer$1, {
    edgeTypes: edgeTypes,
...
var StoreUpdater = function StoreUpdater(_ref) {
  ...
  var _useStore = useStore(selector$5, shallow__default["default"]),
...
var Handle = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var _useStore = useStore(selector$4, shallow__default["default"]),
  ...
  var handleClasses = cc__default["default"](['react-flow__handle', "react-flow__handle-".concat(position), 'nodrag', className, {
    source: !isTarget,
    target: isTarget,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", _objectSpread$6({
...
var DefaultNode = function DefaultNode(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(Handle$1, {
    ...
    position: targetPosition,
    isConnectable: isConnectable
  }), data === null || data === void 0 ? void 0 : data.label, /*#__PURE__*/React__default["default"].createElement(Handle$1, {
    type: "source",
    position: sourcePosition,
    isConnectable: isConnectable
  }));
...
var InputNode = function InputNode(_ref) {
  var data = _ref.data,
      ...
      _ref$sourcePosition = _ref.sourcePosition,
      sourcePosition = _ref$sourcePosition === void 0 ? exports.Position.Bottom : _ref$sourcePosition;
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, data === null || data === void 0 ? void 0 : data.label, /*#__PURE__*/React__default["default"].createElement(Handle$1, {
    type: "source",
    position: sourcePosition,
    isConnectable: isConnectable
  }));
...
function useMemoizedMouseHandler(id, dragging, getState, handler) {
  var memoizedHandler = React.useCallback(function (event) {
...
var wrapNode = (function (NodeComponent) {
  var NodeWrapper = function NodeWrapper(_ref) {
    ...
    var _useStore = useStore(selector$3, shallow__default["default"]),
    ...
    var prevSourcePosition = React.useRef(sourcePosition);
    var prevTargetPosition = React.useRef(targetPosition);
    var prevType = React.useRef(type);
    ...
    var nodeClasses = cc__default["default"](['react-flow__node', "react-flow__node-".concat(type), noPanClassName, className, {
      selected: selected,
      selectable: isSelectable,
      parent: isParent
    }]);
    return /*#__PURE__*/React__default["default"].createElement(reactDraggable.DraggableCore, {
      onStart: onDragStart,
      onDrag: onDrag,
      onStop: onDragStop,
      scale: scale,
...
var areEqual = function areEqual(objA, objB) {
  ...
  return shallow__default["default"](selectedNodeIdsA, selectedNodeIdsB) && shallow__default["default"](selectedEdgeIdsA, selectedEdgeIdsB);
...
var SelectionListener$1 = /*#__PURE__*/React.memo(SelectionListener);
...
function Attribution(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: cc__default["default"](['react-flow__attribution'].concat(_toConsumableArray(positionClasses))),
...
function useNodeOrEdgeTypes(nodeOrEdgeTypes, createTypes) {
  var typesKeysRef = React.useRef(null);
  var typesParsed = React.useMemo(function () {
    if (process.env.NODE_ENV === 'development') {
      var typeKeys = Object.keys(nodeOrEdgeTypes);

      if (shallow__default["default"](typesKeysRef.current, typeKeys)) {
...
var ReactFlow = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var reactFlowClasses = cc__default["default"](['react-flow', className]);
  return /*#__PURE__*/React__default["default"].createElement("div", _objectSpread$2(_objectSpread$2({}, rest), {}, {
    ...
    noWheelClassName: noWheelClassName,
    noPanClassName: noPanClassName
  }), /*#__PURE__*/React__default["default"].createElement(StoreUpdater, {
    nodes: nodes,
    edges: edges,
  ...
  }), onSelectionChange && /*#__PURE__*/React__default["default"].createElement(SelectionListener$1, {
    onSelectionChange: onSelectionChange
  }), children, /*#__PURE__*/React__default["default"].createElement(Attribution, {
...
var MiniMapNode = function MiniMapNode(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("rect", {
    className: cc__default["default"](['react-flow__minimap-node', className]),
    x: x,
    y: y,
    rx: borderRadius,
    ry: borderRadius,
...
var MiniMap = function MiniMap(_ref) {
  ...
  var _useStore = useStore(selector$1, shallow__default["default"]),
  ...
  var mapClasses = cc__default["default"](['react-flow__minimap', className]);
...
var ControlButton = function ControlButton(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("button", _objectSpread$1({
    type: "button",
    className: cc__default["default"](['react-flow__controls-button', className])
  }, rest), children);
};
...
var Controls = function Controls(_ref2) {
  ...
  var mapClasses = cc__default["default"](['react-flow__controls', className]);
...
var defaultColors = (_defaultColors = {}, _defineProperty(_defaultColors, exports.BackgroundVariant.Dots, '#81818a'), _defineProperty(_defaultColors, exports.BackgroundVariant.Lines, '#eee'), _defaultColors);
...
function useViewport() {
  var viewport = useStore(viewportSelector, shallow__default["default"]);
  return viewport;
}
...
function createUseItemsState(applyChangesFunction) {
  return function (initialItems) {
    ...
    var onItemsChange = React.useCallback(function (changes) {
